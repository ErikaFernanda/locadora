...
//            }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                locadora.bd.addCliente(campoNome.getText(), campoEndereco.getText(), campoCPF.getText(), format.format(d), campoCliente_premium.isSelected(),campoTelefone.getText(), campoIdade.getText());

                JOptionPane.showMessageDialog(locadora, "Cliente " + campoNome.getText() + " cadastrado com sucesso !!");
                campoNome.setText("");
    ...
    public void editCliente(JTable tabela) {
        ...
        Editarcc.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                locadora.bd.editarCliente(locadora.listaClientes.tabela, campoNome.getText(), campoEndereco.getText(), campoCPF.getText(), campoCliente_premium.isSelected(), 2, 2);
